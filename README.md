...
- `updateApp()` — recalculates and recreates the plot on any input change
- `createComponents()` — builds all UI elements (slider, input fields, axes, labels)

All inputs are live meaning any changes immediately triggers recalculation and replot.
